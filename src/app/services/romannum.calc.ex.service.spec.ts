...
import { RomannumCalcExService } from './romannum.calc.ex.service';

describe('RomannumCalcExService', () => {
  let service: RomannumCalcExService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [RomannumCalcExService]
    });
    service = TestBed.inject(RomannumCalcExService);
  });
  ...
  it('num2str function invalid', function () {
    ...
    expect(function () { service.num2str(4000000) }).toThrow();
  });
});
